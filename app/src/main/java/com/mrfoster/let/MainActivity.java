...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseListAdapter<ChatMessage> adapter = new FirebaseListAdapter<ChatMessage>(this, ChatMessage.class,
        ...
        protected void populateView(View v, ChatMessage model, int position) {
            ...
            messageTime.setText(sdf.format(model.getMessageTime()));
        }
    };
        ...
        if (item.getItemId() == R.id.menu_sign_out) {
            AuthUI.getInstance().signOut(this).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(MainActivity.this, "You've been signed out.", Toast.LENGTH_LONG).show();
